...
## [0.7.1](https://github.com/jxhhdx/farm/compare/farmfe_core-v0.7.0...farmfe_core-v0.7.1) - 2024-12-02

### Fixed

- freebsd build & cargo publish ([#1938](https://github.com/jxhhdx/farm/pull/1938))
- *(runtime)* async cache ([#1902](https://github.com/jxhhdx/farm/pull/1902))
