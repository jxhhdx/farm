...
## [2.2.0](https://github.com/jxhhdx/farm/compare/farmfe_core-v2.1.0...farmfe_core-v2.2.0) - 2026-04-07

### Added

- *(core)* support umd & css.transformToScript ([#2254](https://github.com/jxhhdx/farm/pull/2254))
- add env manual control thread max nums ([#2249](https://github.com/jxhhdx/farm/pull/2249))

### Fixed

- *(v2)* #2262 HMR does not work with Qiankun framework ([#2263](https://github.com/jxhhdx/farm/pull/2263))
- reduce memory usage ([#2256](https://github.com/jxhhdx/farm/pull/2256))
