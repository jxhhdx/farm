...
## [2.0.2](https://github.com/jxhhdx/farm/compare/create-farm-v2.0.1...create-farm-v2.0.2) - 2026-04-07

### Fixed

- deno create & add dry-run flag ([#2247](https://github.com/jxhhdx/farm/pull/2247))

### Other

- sync v2 docs from code and rename docs/ to website/ ([#2283](https://github.com/jxhhdx/farm/pull/2283))
