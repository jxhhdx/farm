...
_Note: specifying functions that are used at the beginning of a chain, such as 'a().b().c()', will result in '(void 0).b().c()' which will generate an error at runtime._
